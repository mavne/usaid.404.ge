...
<body class="news-page editions-page">
	...
	<section class="all-news">
		<div class="center">
			...
			<div class="editions-box">
				<div class="row">
					<div class="col-md-4">
						<a href="" class="edition">
							<div class="year">2023</div>

							<div class="image-box">
								<div class="image" style="background-image:url('/_markup/assets/img/pdf.png');">
									<img src="/_markup/assets/img/pdf.png" alt="" loading="lazy">
								</div>
							</div>

							<h2>როგორ შეიძლებოდა შოვის ტრაგედიის თავიდან</h2>
